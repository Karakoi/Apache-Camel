package components.dynamicreports.temp;
...
public class Templates {
    ...
    static {
        ...
        dynamicReportsComponent =
                cmp.horizontalList(
                        cmp.image(Templates.class.getResource("../resources/dynamicreports.png")).setFixedDimension(60, 60),
                        cmp.verticalList(
                                cmp.text("DynamicReports").setStyle(bold22CenteredStyle).setHorizontalAlignment(HorizontalAlignment.LEFT),
                                cmp.text("Reports for period: 2017-01-01: 2017-06-17").setStyle(italicStyle))).setFixedWidth(300);
